...
layout= html.Div([
        ...
        html.P("Most recently we've added some ML (Machine Learning) work as well, where we've included the results of classifying fake and authentic news. This was done on a dataset from Kaggle.", style={'textAlign': 'center'}),
        html.P("Feel free to explore the website!", style={'textAlign': 'center'}),
    ])